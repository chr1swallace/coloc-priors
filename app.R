...
"This app is designed to convert the per-SNP raw priors described in",
a("Giambartolomei et al 2014",href="https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1004383"),
":",
p(),
"p12 = Prior probability a random SNP in the region is jointly causal for both traits",br(),
"p1 = Prior probability a random SNP in the region is causally associated with trait 1 and not trait 2",br(),
"p2 = Prior probability a random SNP in the region is causally associated with trait 2 and not trait 1",
p(),
"or the per SNP marginal and conditional priors described in [manuscript in progress]:",
p(),
 "q1|2 = Prior probability a random SNP in the region is jointly causal for both traits given it is causal for trait 2",br(),
 "q1 = Prior probability a random SNP in the region is causally associated with trait 1 (whether or not causal for trait 2)",br(),
 "q2 = Prior probability a random SNP in the region is causally associated with trait 2 (whether or not causal for trait 1)",
p(),
"to per-hypothesis priors, where",
p(),
  "H0 = no association with either trait in region",  br(),
  "H1 = association with trait 1 in region, but not trait 2",  br(),
  "H2 = association with trait 2 in region, but not trait 1",  br(),
  "H3 = association with both traits in region, but seperate causal variants",  br(),
  "H4 = association with both traits in region, same causal variants",
  p(),
